...
class CompletionFieldsProducer extends FieldsProducer {
  ...
  private class CompletionsTermsReader implements Accountable {
    ...
    public synchronized NRTSuggester lookup() throws IOException {
      if (lookup == null) {
    ...
    @Override
    public long ramBytesUsed() {
      return (lookup != null) ? lookup.ramBytesUsed() : 0;
    }
  ...
  public static class CompletionTerms extends FilterLeafReader.FilterTerms {
     ...
     */
    public NRTSuggester lookup() throws IOException {
      if (reader == null) {
        return null;
      }
