 ...
 *   <li>FST --&gt; {@link NRTSuggesterBuilder FST&lt;Long, BytesRef&gt;}</li>
 ...
 *
 * @lucene.experimental
 * @see CompletionFieldsConsumer
 * @see CompletionFieldsProducer
 */
public abstract class CompletionPostingsFormat extends PostingsFormat {

  public static final String CODEC_NAME = "completion";
  public static final int COMPLETION_CODEC_VERSION = 1;
  public static final int COMPLETION_VERSION_CURRENT = COMPLETION_CODEC_VERSION;
  public static final String INDEX_EXTENSION = "cmp";
  public static final String DICT_EXTENSION = "lkp";
   ...
   */
  protected abstract PostingsFormat delegatePostingsFormatName();

  @Override
  public FieldsConsumer fieldsConsumer(SegmentWriteState state) throws IOException {
    PostingsFormat delegatePostingsFormat = delegatePostingsFormatName();
