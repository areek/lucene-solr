 ...
 * to analyze the prefix of the query term. The default
 * scoring mode is {@link CompletionQuery#IGNORE_BOOST}
 * <p>
...
public class PrefixCompletionQuery extends CompletionQuery {
   ...
   * with no filter
   */
  public PrefixCompletionQuery(Analyzer analyzer, Term term) throws IOException {
   ...
   */
  public PrefixCompletionQuery(Analyzer analyzer, Term term, Filter filter) throws IOException {
    super(term, filter);
