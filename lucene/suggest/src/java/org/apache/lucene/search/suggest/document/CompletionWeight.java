...
public class CompletionWeight extends Weight {
  ...
  public CompletionWeight(final IndexReader reader, final CompletionQuery query,
    ...
    this.scoreMode = query.getScoreMode();
  ...
  /**
   * The score mode for this weight.
   * see {@link CompletionQuery#setScoreMode(ScoreMode)}
   *
   * @return query score mode
   */
  ...
  public BulkScorer bulkScorer(final LeafReaderContext context, Bits acceptDocs) throws IOException {
    ...
    return new CompletionScorer(this, suggester, scoreMode, reader, acceptDocBits,
        filter != null, automaton, minWeight, maxWeight);
  }
