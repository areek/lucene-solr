 ...
 * within an edit distance of the specified prefix. The default
 * scoring mode is {@link CompletionQuery#BOOST_FIRST}
 * <p>
 * This query boost documents relative to how similar the indexed terms are to the
 * provided prefix. To turn off this boosting, set the scoring mode to
 * {@link CompletionQuery#IGNORE_BOOST}.
 * <p>
...
public class FuzzyCompletionQuery extends PrefixCompletionQuery {
   ...
   * with no filter
   */
  public FuzzyCompletionQuery(Analyzer analyzer, Term term) throws IOException {
   ...
   * for defaults
   */
  public FuzzyCompletionQuery(Analyzer analyzer, Term term, Filter filter) throws IOException {
  ...
  public FuzzyCompletionQuery(Analyzer analyzer, Term term, Filter filter, int maxEdits,
                              ...
                              boolean unicodeAware, int maxDeterminizedStates) throws IOException {
  ...
  public Weight createWeight(IndexSearcher searcher, boolean needsScores) throws IOException {
    ...
    if (getScoreMode() != IGNORE_BOOST) {
      return new FuzzyCompletionWeight(searcher.getIndexReader(), this, automaton, refs);
    } else {
      return new CompletionWeight(searcher.getIndexReader(), this, automaton);
    }
  }
